      ...
      <section className="partner">
        ...
        <div className="theme_container">
          ...
          >
            ...
            <SwiperSlide className="image">
              <img src="assets/images/resource/cta-3.png" alt="" />
            </SwiperSlide>
            <SwiperSlide className="image">
              <img src="assets/images/resource/cta-4.png" alt="" />
            </SwiperSlide>
            <SwiperSlide className="image">
              <img src="assets/images/resource/cta-5.png" alt="" />
            </SwiperSlide>
            <SwiperSlide className="image">
              <img src="assets/images/resource/cta.png" alt="" />
            </SwiperSlide>
      ...
      <section className="testimonial">
        <div className="theme_container">
          <div className="row no-gutters">
            <div className="col-lg-6">
              <div className="inner-container">
                ...
                <div className="testimonial-area">
                  <Swiper
                    {...testimonialSlider}
                    className="one-item-carousel owl-theme owl-carousel"
                  >
                    <SwiperSlide>
                      <div className="testimonial-block">
                        ...
                        <div className="text">
                          ...
                          voluptatem accusantium dolorem laudantiums totam
                          aperiam eaqupsa inventore{" "}
                        </div>
            ...
            <div
              className="col-lg-6 image-column"
              style={{
                backgroundImage: "url(assets/images/resource/test.jpg)",
              }}
            >
              <div className="image">
                <img src="assets/images/resource/test.jpg" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="news-block">
                <div className="image">
                  <img src="assets/images/resource/news.jpg" alt="" />
                </div>
                <div className="lower-content">
                  <div className="post-cat">Water</div>
                  <div className="date">
            ...
            <div className="col-lg-4">
              <div className="news-block">
                ...
                <div className="lower-content">
                  <div className="post-cat">Game</div>
                  <div className="date">
                    <i className="far fa-calendar-alt" />
                    05 January 2022
                  </div>
